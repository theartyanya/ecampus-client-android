...
import ua.kpi.campus.util.CollectionValidator;
...
public class GridSubsystemAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            view = mInflater.inflate(ua.kpi.campus.R.layout.gridview_item_subsystem,
                    viewGroup, false);
    ...
    protected static class GridViewHolder {
        @Bind(ua.kpi.campus.R.id.image_view_subsystem_logo)
        ImageView viewIcon;
        @Bind(ua.kpi.campus.R.id.text_view_subsystem_name)
        TextView viewTitle;
