...
import ua.kpi.campus.ui.adapter.SubsystemAdapter;
import ua.kpi.campus.ui.presenter.MainNotAuthPresenter;
...
public class MainNotAuthActivity extends BaseActivity implements
    ...
    Toolbar mToolbar;
    @Bind(ua.kpi.campus.R.id.recycler_view_subsystems)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(ua.kpi.campus.R.layout.activity_main_not_auth);
        bindViews();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(ua.kpi.campus.R.menu.menu_main_not_auth, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case ua.kpi.campus.R.id.action_login:
                mPresenter.openLogin();
                break;
            case ua.kpi.campus.R.id.action_settings:
                break;
        }
