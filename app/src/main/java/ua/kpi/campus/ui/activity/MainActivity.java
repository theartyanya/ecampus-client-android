...
public class MainActivity extends BaseActivity implements MainPresenter.IView {
    ...
    Toolbar mToolbar;
    @Bind(ua.kpi.campus.R.id.grid_view_subsystem)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(ua.kpi.campus.R.layout.activity_main);
        bindViews();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(ua.kpi.campus.R.menu.menu_main, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case ua.kpi.campus.R.id.action_logout:
                showLogoutDialog();
