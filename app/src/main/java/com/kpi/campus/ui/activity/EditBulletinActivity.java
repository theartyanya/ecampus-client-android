 ...
 */
public class EditBulletinActivity extends BaseActivity implements EditBulletinPresenter.IView {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_delete:
                ToastUtil.showShortMessage("Видалено", this);
                finish();
                break;
    ...
    private void setToolbar() {
        ...
        getSupportActionBar().setTitle(R.string.edit_new_bulletin);
    }
}
