...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	//Inserted by DirtyNewYorker:
	int pressedColor = 0xffffffff;
	int notSoPressedColor = 0x88ffffff;
	...
	private void updateTabStyles() {
		...
		for (int i = 0; i < tabCount; i++) {
			...
			tabBackgroundDrawable.setExitFadeDuration(125);
			tabBackgroundDrawable.addState(
