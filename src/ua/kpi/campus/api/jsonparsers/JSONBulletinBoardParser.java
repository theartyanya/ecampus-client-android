...
public class JSONBulletinBoardParser {
    ...
    public static JsonObject<ArrayList<BulletinBoardSubject>> parse(String jsonString) throws JSONException {
        ...
        return new JsonObject<ArrayList<BulletinBoardSubject>>(
                jsonObj.getInt(STATUS_CODE_ATTRIBUTE_NAME),
                Timestamp.valueOf(timeStampString),
                jsonObj.getString(GUID_ATTRIBUTE_NAME),
                jsonObj.getString(PAGING_ATTRIBUTE_NAME),
               JSONArrayParsers.parseBulletinBoard(jsonObj) );
    }
